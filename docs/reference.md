...
nothing folded (its tag menu has the same switch). Until you drag, every browser, the phone included, reads
the tabs in the order romp has kept for them. The order you have DRAGGED your tabs into follows
