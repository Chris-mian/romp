...
on a server, or across several machines that
[link into one fleet](guide.md#more-machines-one-fleet). You open that dashboard
the same way from anywhere: a browser, [your phone](guide.md#your-phone), or the
