...
test("each toggle item carries an icon (slashed when off) and a sub-description", () => {
  assert.match(SRC, /function ctxIcon\(kind: "feed" \| "mail" \| "bell" \| "bill" \| "folder" \| "tag" \| "pencil" \| "key" \| "restart", off: boolean\)/);   // bill 2026-08-09; folder/tag/pencil 2026-08-24; the split kind went with the menu item (the drag, 2026-09-11); key 2026-09-10 (the tab menu's Hot key… row); restart 2026-09-23 (Restart session)
