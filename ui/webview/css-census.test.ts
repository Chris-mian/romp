...
const EXACT: Record<string, number> = {
  ...
  "gear.css": 13,   // +1 (T379): the widget rows' demo draws the strip's unknown ring in the strip's own literal #8a8a8a (styles.css .tab-dot.unknown, the network strip's down-host gray), byte-equal so the demo and the strip agree; +1 (T290): .rs-log-n's #ff6b6b, the Log cue's red — a STATUS colour, byte-equal to the shell's
