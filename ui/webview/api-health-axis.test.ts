...
test("T340: the other band's hue per theme, and the inks and fills that follow it", () => {
  ...
  assert.ok(KERNEL.includes(".ah-c-r429{color:#ef6b6f}.ah-c-r5xx{color:var(--st-5xx-ink,#c4b5fd)}") && KERNEL.includes("body.theme-light .ah-c-r429{color:#B02A1C}body.theme-light .ah-c-r5xx{color:var(--st-5xx-ink,#4c1d95)}"));   // the 5xx ink through its token since 2026-09-21 (plans/needs-you.md)
});
