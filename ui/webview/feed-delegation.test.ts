...
test("a narrow card WRAPS the '↪ from' provenance under the name instead of overlapping the chips (the user 2026-06-20)", () => {
  ...
  assert.match(FEED, /row2\.append\(idwrap, origin, fupBadge, nfBadge, intingBadge, intBadge, warnChip, waitOnBadge, statBtn, clr\)/, "origin is a row2 sibling of the chips");
