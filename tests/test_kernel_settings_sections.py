...
class SettingsSectionsTest(unittest.TestCase):
    def test_the_four_subsection_headers_are_present_in_order(self):
        h = km._GEAR_HTML
    ...
    def test_each_setting_sits_under_the_right_section(self):
        ...
        # Sessions: backend, default dir, auto-nudge between Sessions and Debug
        self.assertTrue(h.index(">Sessions<") < h.index("id=rs-backend") < h.index(">Debug<"))
        self.assertTrue(h.index(">Sessions<") < h.index("id=rs-defaultdir") < h.index(">Debug<"))
        self.assertTrue(h.index(">Sessions<") < h.index("id=rs-autonudge") < h.index(">Debug<"))
