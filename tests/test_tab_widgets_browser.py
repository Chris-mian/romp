...
class ServedTabWidgets(unittest.TestCase):
    ...
    def test_the_ring_rows_list_the_three_rings_in_precedence_order_with_a_switch_and_a_live_demo_each_and_no_grip(self):
        ...
        self.assertEqual(g["hint"], "With the outline ring, one cue at a time: the first state that applies wins, in this order. With the state badge on, the Needs-you count also shows beside Blocked and retrying.", table)
