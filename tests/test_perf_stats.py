...
class Collector(unittest.TestCase):
    ...
    def test_snapshot_has_the_documented_shape_and_starts_at_zero(self):
        ...
        self.assertEqual(set(snap["memos"]), {"pass", "shared", "chain", "nudgeGate", "nudgeWalk", "sessionsListing", "cleared", "courierSkip", "backref", "captions", "goalArchive", "plannerSkip", "ghostDropped",
