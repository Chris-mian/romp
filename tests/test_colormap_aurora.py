...
class Aurora(unittest.TestCase):
    ...
    def test_ends_are_the_true_romp_purple_and_green(self):
        stops = cm.stops_for("aurora")
        # per-anchor chroma is preserved, so the ends faithfully ARE the romp shades
        self.assertEqual(stops[-1], (84, 178, 4), "green end is the romp green #54B204")
        r0, g0, b0 = stops[0]
        self.assertGreater(b0, g0, "purple end: blue channel above green")
