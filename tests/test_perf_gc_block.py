...
FREEZE_KEYS = {"enabled", "active", "loadTrees", "backstopFoldins", "freezes", "reclaims", "survivors", "lastReleaseSids", "endedPending", "lastReconcileMs", "lastReconcileKind", "totalReconcileMs", "errors"}
